...
def test_calculate_day_of_week_averages(sample_data):
...
def test_plot_day_of_week_averages(sample_data, tmp_path):
...
def test_print_day_of_week_summary(sample_data, caplog):
