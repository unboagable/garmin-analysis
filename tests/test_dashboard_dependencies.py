...
class TestDashboardDependencies:
    ...
    def test_load_master_dataframe(self, tmp_db):
    ...
    @pytest.mark.integration
    def test_correlation_matrix(self, tmp_db):
        df = load_master_dataframe()
    ...
    @pytest.mark.integration
    def test_correlation_matrix_edge_cases(self, tmp_db):
    ...
    def test_dash_app_layout_structure(self):
