...
class TestPipelineEndToEnd:
    ...
    def test_runs_end_to_end(self, sample_health_data, tmp_path):
...
class TestAnomalyDetectionPipeline:
    ...
    def test_with_valid_data(self, sample_health_data, tmp_path):
    ...
    def test_error_handling(self, sample_health_data, tmp_path):
...
class TestPipelineRecommendations:
    ...
    def test_high_anomaly_rate(self, tmp_path):
    ...
    def test_low_clustering_quality(self, tmp_path):
    ...
    def test_high_missing_data(self, tmp_path):
...
class TestPipelineSaveResults:
    ...
    def test_creates_files(self, sample_health_data, tmp_path):
    ...
    def test_markdown_report(self, sample_health_data, tmp_path):
...
class TestPipelineHelpers:
    ...
    def test_all_submodule_failures(self, sample_health_data, tmp_path):
    ...
    def test_feature_analysis(self, sample_health_data, tmp_path):
    ...
    def test_modeling_summary(self, tmp_path):
