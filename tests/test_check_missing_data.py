...
def test_audit_table_health_with_valid_tables(mem_db):
...
def test_audit_table_health_with_various_patterns(mem_db):
...
def test_main_with_no_export(tmp_path):
...
def test_main_with_nonexistent_database():
