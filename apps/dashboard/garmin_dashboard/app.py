        ...
        [
            ...
            dcc.Tabs(
                [
                                    ...
                                    html.Div(
                                        [
                                            ...
                                            dcc.Checklist(
                                                ...
                                                options=[
                                                    {
                                                        "label": " Only days with 24-hour continuous coverage",
                                                        "value": "filter",
                                                    }
                                                ],
                                                value=[],
                                            ...
                                            dcc.Checklist(
                                                ...
                                                options=[
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        "value": "body_battery_max",
                                                    },
                                                    {
                                                        "label": "Body Battery Min",
                                                        "value": "body_battery_min",
                                                    },
                                                    {
                                                        "label": "Water Intake",
                                                        "value": "water_intake",
                                    ...
                                    html.Div(
                                        [
                                            ...
                                            dcc.DatePickerRange(
                                                ...
                                                start_date=max(
                                                    df["day"].max() - pd.Timedelta(days=30),
                                                    df["day"].min(),
                                                ),
                                                end_date=df["day"].max(),
                    ...
                    dcc.Tab(
                        label="📊 24-Hour Coverage Analysis",
                        children=[
                            html.Div(
                                [
                                    html.Div(
                                        [
                                            ...
                                            html.P(
                                                "Analyze which days have complete 24-hour heart rate monitoring coverage (indicates watch was worn continuously)"
                                            ),
                                        ],
                                        style={"margin": "10px"},
                                    ),
                                ...
                                [
                                    html.Div(
                                        [
                                            ...
                                            html.P(
                                                "Composite score (0-100) combining 24h coverage and metric completeness. Higher = better data."
                                            ),
                                    ...
                                    html.Div(
                                        [
                                            ...
                                            dcc.DatePickerRange(
                                                ...
                                                start_date=max(
                                                    df["day"].min(),
                                                    df["day"].max() - pd.Timedelta(days=90),
                                                ),
                                                end_date=df["day"].max(),
                                                display_format="YYYY-MM-DD",
                                            ),
                                ...
                                [
                                    ...
                                    html.Div(
                                        [
                                            ...
                                            html.P(
                                                "Your best sleep occurs when steps are between A–B or intensity minutes are between A–B."
                                            ),
                                        ],
                                        style={"margin": "10px"},
                                    ),
                                    html.Div(
                                        id="optimal-sleep-summary",
                                ...
                                [
                                    html.Div(
                                        [
                                            ...
                                            html.P(
                                                "Analyze how your stress levels vary by hour of day and day of week"
                                            ),
                                        ],
                                        style={"margin": "10px"},
                                    ),
                                    html.Div(
                                        [
                                            ...
                                            dcc.Checklist(
                                                ...
                                                options=[
                                                    {
                                                        "label": " Show day-of-week breakdown",
                                                        "value": "weekday",
                                                    }
                                                ],
                                                value=["weekday"],
                            ...
                            html.Div(
                                [
                                    ...
                                    dcc.Dropdown(
                                        id="metric-dropdown",
                                        options=[
                                            {"label": m, "value": m} for m in available_metrics
                                        ],
                                        value="stress_avg",
                                        clearable=False,
                                    ),
...
def update_plot(
    ...
    coverage_filter,
    coverage_gap_minutes=None,
    coverage_edge_minutes=None,
    coverage_allowance_minutes=None,
):
    try:
        ...
        if "filter" in coverage_filter:
            ...
            try:
                max_gap_minutes = (
                    int(coverage_gap_minutes) if coverage_gap_minutes is not None else 2
                )
            ...
            try:
                edge_minutes = (
                    int(coverage_edge_minutes) if coverage_edge_minutes is not None else 2
                )
                if edge_minutes < 0:
                    edge_minutes = 2
            except (TypeError, ValueError):
            ...
            try:
                allowance_minutes = (
                    int(coverage_allowance_minutes) if coverage_allowance_minutes is not None else 0
                )
        ...
        has_coverage_data = (
            "coverage_pct" in filtered.columns or "has_24h_coverage" in filtered.columns
        )
...
@app.callback(
    [Output("dow-bar-chart", "figure"), Output("dow-combined-chart", "figure")],
    [
...
def update_day_of_week_charts(
    selected_metrics,
    coverage_filter,
    coverage_gap_minutes_dow=None,
    coverage_edge_minutes_dow=None,
    coverage_allowance_minutes_dow=None,
):
    ...
    try:
        ...
        if "filter" in coverage_filter:
            ...
            try:
                max_gap_minutes = (
                    int(coverage_gap_minutes_dow) if coverage_gap_minutes_dow is not None else 2
                )
                if max_gap_minutes < 1:
                    max_gap_minutes = 2
            except (TypeError, ValueError):
            ...
            try:
                edge_minutes = (
                    int(coverage_edge_minutes_dow) if coverage_edge_minutes_dow is not None else 2
                )
                if edge_minutes < 0:
                    edge_minutes = 2
            except (TypeError, ValueError):
            ...
            try:
                allowance_minutes = (
                    int(coverage_allowance_minutes_dow)
                    if coverage_allowance_minutes_dow is not None
                    else 0
                )
                if allowance_minutes < 0:
                    allowance_minutes = 0
...
@app.callback(
    [Output("30day-combined-chart", "figure"), Output("30day-individual-charts", "figure")],
    [
...
def update_30day_charts(
    start_date,
    end_date,
    selected_metrics,
    coverage_filter,
    coverage_gap_minutes_30day=None,
    coverage_edge_minutes_30day=None,
    coverage_allowance_minutes_30day=None,
):
    ...
    try:
        ...
        if "filter" in coverage_filter:
            ...
            try:
                max_gap_minutes = (
                    int(coverage_gap_minutes_30day) if coverage_gap_minutes_30day is not None else 2
                )
                if max_gap_minutes < 1:
                    max_gap_minutes = 2
            except (TypeError, ValueError):
            ...
            try:
                edge_minutes = (
                    int(coverage_edge_minutes_30day)
                    if coverage_edge_minutes_30day is not None
                    else 2
                )
                if edge_minutes < 0:
                    edge_minutes = 2
            ...
            try:
                allowance_minutes = (
                    int(coverage_allowance_minutes_30day)
                    if coverage_allowance_minutes_30day is not None
                    else 0
                )
                if allowance_minutes < 0:
                    allowance_minutes = 0
...
@app.callback(
    ...
    [Input("coverage-date-picker", "start_date"), Input("coverage-date-picker", "end_date")],
)
def update_coverage_charts(start_date, end_date):
    ...
    try:
        ...
        if not has_coverage_data:
            ...
            empty_stats = html.P(
                "Coverage metrics not available in dataset. Run data ingestion to calculate."
            )
        ...
        timeline_fig.add_hline(
            y=24, line_dash="dash", line_color="green", annotation_text="24 hours (full coverage)"
        )
        ...
        pct_fig.add_hline(
            y=95, line_dash="dash", line_color="green", annotation_text="95% (excellent)"
        )
        pct_fig.add_hline(y=80, line_dash="dash", line_color="orange", annotation_text="80% (good)")
        ...
        if "coverage_pct" in df.columns and "has_24h_coverage" in df.columns:
            ...
            monthly_coverage = (
                ...
                .agg({"coverage_pct": "mean", "has_24h_coverage": "sum", "day": "count"})
                .reset_index()
            )
            monthly_coverage.columns = [
                "year",
                "month",
                "month_name",
                "avg_coverage_pct",
            ...
            if not monthly_coverage.empty:
                ...
                heatmap_data = monthly_coverage.pivot(
                    index="year", columns="month", values="avg_coverage_pct"
                )
        ...
        if "coverage_pct" in df.columns and "has_24h_coverage" in df.columns:
            ...
            if not valid_coverage.empty:
                ...
                days_with_24h = (
                    valid_coverage["has_24h_coverage"].sum()
                    if "has_24h_coverage" in valid_coverage.columns
                    else 0
                )
                        ...
                        [
                            ...
                            html.Div(
                                [
                                    ...
                                    html.P(
                                        f"Days with 24h Coverage ({pct_24h:.1f}%)",
                                        style={"margin": "0", "fontSize": "12px"},
                                    ),
                                ],
                                style={
    ...
    try:
        ...
        if dq_df.empty:
            ...
            empty_fig.update_layout(
                title="No data quality data. Run data ingestion to generate.", height=400
            )
            return (
                empty_fig,
                empty_fig,
        ...
        timeline_fig.add_hline(
            y=80, line_dash="dash", line_color="green", annotation_text="80 (good)"
        )
        timeline_fig.add_hline(
            y=50, line_dash="dash", line_color="orange", annotation_text="50 (fair)"
        )
        timeline_fig.update_layout(
            ...
            [
                html.Div(
                    [
                        html.H5(
                            f"{avg_score:.1f}",
                            style={"margin": "0", "fontSize": "24px", "color": "#1f77b4"},
                        ),
                        html.P(
                            "Average Data Quality Score", style={"margin": "0", "fontSize": "12px"}
                        ),
                    ],
                    style={
                        "display": "inline-block",
                ...
                html.Div(
                    [
                        html.H5(
                            f"{high_quality} ({pct_high:.1f}%)",
                            style={"margin": "0", "fontSize": "24px", "color": "#2ca02c"},
                        ),
                ...
                html.Div(
                    [
                        html.H5(
                            f"{total}",
                            style={"margin": "0", "fontSize": "24px", "color": "#888888"},
                        ),
        ...
        if "weekday" in show_weekday:
            ...
            if not hourly_weekday_stats.empty:
                ...
                heatmap_data = hourly_weekday_stats.pivot(
                    index="day_of_week", columns="hour", values="mean"
                )
                ...
                heatmap_fig.update_layout(title="Weekday breakdown not available")
        else:
            heatmap_fig.update_layout(title='Enable "Show day-of-week breakdown" to see this chart')
...
try:
    ...
    app.layout = html.Div(
        [
            ...
            html.P(
                "Please ensure the data ingestion script has been run first.",
