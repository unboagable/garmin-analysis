...
class TestRunAllAnalytics:
    ...
    def test_full_report(self, sample_health_data, tmp_path):
        ...
        with patch(
            ...
            report_path = run_all_analytics(
                sample_health_data, output_dir=str(tmp_path), monthly=False
            )
    ...
    @pytest.mark.integration
    def test_monthly_report(self, sample_health_data, tmp_path):
        ...
        with patch(
            ...
            report_path = run_all_analytics(
                sample_health_data, output_dir=str(tmp_path), monthly=True
            )
    ...
    def test_monthly_filters_data(self, sample_health_data, tmp_path, caplog):
        ...
        with patch(
            ...
            assert (
                "Filtered data to monthly range" in caplog.text or "monthly" in caplog.text.lower()
            )
    ...
    def test_creates_output_directory(self, sample_health_data, tmp_path):
        ...
        with patch(
            ...
            report_path = run_all_analytics(
                sample_health_data, output_dir=str(nested_dir), monthly=False
            )
    ...
    def test_with_anomalies_detected(self, sample_health_data, tmp_path):
        """Test report generation when anomalies are detected."""
        # Create mock anomalies
        anomalies_df = pd.DataFrame(
            {"day": pd.date_range("2024-01-01", periods=3), "anomaly_score": [0.95, 0.92, 0.88]}
        )
        ...
        with patch(
            ...
            report_path = run_all_analytics(sample_health_data, output_dir=str(tmp_path))
    ...
    def test_with_no_anomalies(self, sample_health_data, tmp_path):
    ...
    def test_includes_timestamp(self, sample_health_data, tmp_path):
    ...
    def test_references_trend_summary(self, sample_health_data, tmp_path):
    ...
    def test_monthly_with_insufficient_data(self, tmp_path):
        ...
        with patch(
            ...
            report_path = run_all_analytics(small_data, output_dir=str(tmp_path), monthly=True)

            # Should still create report (even with limited data)
            assert Path(report_path).exists()

    def test_with_custom_date_column(self, sample_health_data, tmp_path):
        ...
        with patch(
            ...
            report_path = run_all_analytics(custom_df, date_col="date", output_dir=str(tmp_path))
...
class TestAnalyticsIntegration:
    def test_24h_coverage_filtering(self, sample_health_data, tmp_path):
        ...
        with (
            patch("garmin_analysis.features.coverage.filter_by_24h_coverage") as mock_filter,
            patch(
                "garmin_analysis.reporting.run_all_analytics.run_anomaly_detection"
            ) as mock_anomaly,
        ):
    ...
    def test_24h_coverage_adds_note(self, sample_health_data, tmp_path):
        ...
        with (
            ...
            report_path = run_all_analytics(
                sample_health_data, output_dir=str(tmp_path), filter_24h_coverage=True
            )
    ...
    def test_html_output(self, sample_health_data, tmp_path):
        ...
        with patch(
            ...
            report_path = run_all_analytics(
                sample_health_data, output_dir=str(tmp_path), as_html=True
            )
    ...
    def test_html_vs_markdown(self, sample_health_data, tmp_path):
        ...
        with patch(
            ...
            # Generate markdown
            md_path = run_all_analytics(sample_health_data, output_dir=str(tmp_path), as_html=False)
